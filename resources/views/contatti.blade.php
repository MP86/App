...
================================================== -->
  <body>
    ...
    <div class="row">
     ...
     <h1>Vuoi saperne di piu?</h1>
      ...
      <div class="row featurette">
        <div class="col-md-12">
          <h2 class="featurette-heading">Allora manda una mail a:<span class="text-muted">matteopretolani86@gmail.com</span></h2>
	...
	<div>
		<!-- FOOTER -->
      <footer>
        <p class="pull-right"><a href="/"><button type="button" class="btn btn-info">Torna alla Home</button></a></p>
