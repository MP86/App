          ...
          <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
              <ul class="nav navbar-nav">
              	<li class="active"><a href="">Pagina personale utente</a></li>
                <li><a href=""></a></li>
                <li><a href="UtentiController@edit"><button type="button" class="btn btn-primary">Modifica dati utente</button></a></li>
                <li><a href=""></a></li>
                <li><a href="ProblemiController@create"><button type="button" class="btn btn-info">Crea probllema</button></a></li>
              </ul>
            </div>
          </div>
        </nav>
